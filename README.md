...
## usage
The motor is placed inside the mannequin arm to move it while the PIR sensor is pointed toward the room entry, a aux adapter was to connect a generic audio speaker and place it near the mannequin but you can use other types (as shown in the image).

## final notes

This repo is intended for the commissioner as a manual and documentation of work, we where inexperienced during the realization but managed to create a solid working implementation.
